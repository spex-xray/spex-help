...
Unpack it in a convenient directory::
    ...
    unix:~/Software> tar xvfj spex-3.08.02-Source.tar.bz2
...
where CMakeLists.txt is located (mind the dot)::
    ...
    unix:~/Software/SPEX-3.08.02-Source> cmake .
...
Install SPEX at a different location in the 'make install' step::
    ...
    unix:~/Software/SPEX-3.08.02-Source> cmake . -DCMAKE_INSTALL_PREFIX=/home/user/software
...
The use of the SPEX libraries in the source tree can be forced::
    ...
    unix:~/Software/SPEX-3.08.02-Source> cmake . -DPGPLOT=YES
