...
Users also have the option to introduce a time-varying absorber between
the light source and the target plasma, with mode = 3. This choice is
particularly relevant for scientific cases focused on the evolution of
warm absorbers with the presence of an intermittent obscurer at a smaller radius.
It is in principle possible to simulate a time-varying SED with changing hardness
