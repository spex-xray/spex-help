...
in units of :math:`10^{44}`Â ph :math:`\mathrm{s}^{-1}`:math:`\mathrm{keV}^{-1}`, and
...
:math:`E_1`â€“:math:`E_2`. If you choose this option, the parameter "type"
...
.. Warning:: When you do spectral fitting, you **must** keep either
   ...
   command. SPEXÂ does not check this for you! If you do not do this, you
...
.. Warning:: The conversion factor between :math:`L` and :math:`A` is
   ...
   conversion factors) for :math:`E<10^{-7}`Â keV become inaccurate.
