...
`How to install Ubuntu in Windows 11 <https://ubuntu.com/tutorials/install-ubuntu-on-wsl2-on-windows-11-with-gui-support>`_
...
5. Remove the tar file: rm spex-3.08.02-Ubuntu-WSL.tar.gz
